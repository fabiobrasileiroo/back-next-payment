  ...
  try {
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f4f4f4; padding: 20px; border-radius: 10px; max-width: 600px; margin: 0 auto;">
      ...
      <p style="text-align: center; margin-bottom: 30px;">
        <a href="#" style="padding: 12px 25px; background-color: #d6d6d6; color: black; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; font-size: 16px;">Copiar o código manualmente</a>
      </p>
